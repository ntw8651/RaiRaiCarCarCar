...
namespace Ezereal
{
    public class EzerealCarController : MonoBehaviour // This is the main system resposible for car control.
    {
        ...
        public float downForce = 100f; // 100f default
        ...
        private void FixedUpdate()
        {
            ...
            //Fast DownForce
            vehicleRB.AddForce(downForce * Vector3.down * Vector3.Dot(vehicleRB.gameObject.transform.forward, vehicleRB.velocity));
